...
SECRET_KEY = 'django-insecure-&o0ky+^*a((3yyg@gyqs1$i5skq+t01%31hf@r#7c3^o+f1n+n'
...
# // Live database from elephant SQL 
DATABASES = {
    'default': {
...
# // postgresql database for local test
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.postgresql',
#         'NAME': 'devsearch',
...
# // sqlite database for local test
# DATABASES = {
#     'default': {
